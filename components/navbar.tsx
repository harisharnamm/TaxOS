      ...
      <div className="w-[calc(100%-24px)] max-w-[1400px] mt-2">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-3">
            <CalBooking
              className="bg-transparent hover:bg-white/10 border border-white/30 rounded-lg px-4 py-2 text-white font-mono text-sm font-semibold tracking-wider transition-colors"
              style={{
                fontFamily:
        ...
        >
          <div className="p-4 flex flex-col gap-4">
            <CalBooking
              className="bg-transparent hover:bg-white/10 border border-white/30 rounded-lg w-full justify-start px-4 py-3 text-white font-mono text-sm font-semibold tracking-wider transition-colors"
              style={{
                fontFamily:
                  'GeistMono, ui-monospace, SFMono-Regular, "Roboto Mono", Menlo, Monaco, "Liberation Mono", "DejaVu Sans Mono", "Courier New", monospace',
                fontSize: "14px",
